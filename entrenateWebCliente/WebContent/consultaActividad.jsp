...
<title>EntrenamosUy | Consulta Actividad Deportiva</title>
</head>
<body>
...
<<nav class="navbar navbar-expand-lg navbar-light bg-light"> <a
	...
	<h1>Consultar: Actividad Deportiva </h1>
	<form action="Consultas" method="post">
		<input type="hidden" name="boton" id="boton" value="">
		<div class="form-group">
			<label for="exampleInputPassword1">Nombre de la Actividad Deportiva</label> <input type="text"
				name="actividadDep" class="form-control" id="exampleInputPassword1"
				placeholder="nombre Actividad Deportiva">
		</div>
		
		<button type="button" class="btn btn-primary"
			onclick="procesar('actividad')">Consulta de Actividad Deportiva</button>
