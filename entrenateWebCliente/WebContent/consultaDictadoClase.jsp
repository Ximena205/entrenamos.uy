...
<<nav class="navbar navbar-expand-lg navbar-light bg-light"> <a
	...
	<h1>Consultar Dictado Clase </h1>
	<form action="ConsultaDictadoClase" method="post">
		<input type="hidden" name="boton" id="boton" value="">
		<div class="form-group">
			<label for="exampleInputPassword1">Nickanme profesor</label> <input type="text"
				name="nickUsuario" class="form-control" id="exampleInputPassword1"
				placeholder="Nickname del usuario">
	
		
			<div class="form-group">
			<label for="exampleInputPassword1">Nombre clase</label> <input type="text"
				name="nomClase" class="form-control" id="exampleInputPassword1"
				placeholder="nomClase">
		</div>
		
		<button type="button" class="btn btn-primary"
			onclick="procesar('usuario')">Consultar</button>
