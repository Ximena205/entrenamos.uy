	...
	public void agregarDtProfesor(DtProfesor usuario) throws UsuarioEnUsoExcepcion {
		// TODO Auto-generated method stub
				...
				if (nuevoUsuario != null) {
					...
					nuevoUsuario = new Profesor (usuario.getNickname(), usuario.getPass(), usuario.getNombre(), usuario.getApellido(), usuario.getEmail(), usuario.getFechaNac(), usuario.getDescripcion(), usuario.getBiogrfia(), usuario.getSitioweb(), true);	
