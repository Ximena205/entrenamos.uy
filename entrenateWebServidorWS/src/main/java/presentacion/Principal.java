...
public class Principal {
    ...
    private ConsultaDictadoClase consultaDictadoClaseFrame;
    ...
    public Principal() {
		...
		consultaDictadoClaseFrame = new ConsultaDictadoClase(iinst);//lo instancio
		jInternalFrameSize = consultaDictadoClaseFrame.getSize();
		consultaDictadoClaseFrame.setLocation((desktopSize.width - jInternalFrameSize.width)/2,//lo pongo en el medio de la pantalla
		(desktopSize.height- jInternalFrameSize.height)/2);
		consultaDictadoClaseFrame.setVisible(false);//lo hago invisible
		frame.getContentPane().add(consultaDictadoClaseFrame);//lo agrego
    }
    ...
    private void initialize() {
        ...
        JMenuItem mntmConsultaDictadoClase = new JMenuItem("Consulta Dictado Clase");
        mntmConsultaDictadoClase.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		consultaDictadoClaseFrame.setVisible(true);
        	}
        });
        mnInformacion.add(mntmConsultaDictadoClase);
